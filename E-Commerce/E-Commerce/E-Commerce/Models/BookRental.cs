...
namespace E_Commerce.Models
{
    public class BookRental : BaseEntity
    {
        ...
        // Qaytarma tarixinə 1 gün qalmış xəbərdarlıq maili göndərilibmi (təkrar göndərməmək üçün)
        public bool DueSoonEmailSent { get; set; } = false;

        // Vaxtında qaytarılmadıqda bir dəfəlik tətbiq olunan sabit cərimə (-5 AZN) artıq tutulubmu
